...
# Debugging, Question 10 - TF-IDF
# https://launchschool.com/exercises/4044b772
#
# A friend of yours wants to build a basic search engine and starts 
# reading up on information extraction. He decides to try a 
# simple implementation of TF-IDF, a measure of the information 
# content a term holds for a particular document in a document 
# collection. However, he just started learning to code and somehow 
# his numbers do not match what is expected. He knows you're enrolled 
...
def tfidf(term, document, documents)
  #puts "tfidf(#{term}, #{document})"
  tfreq = tf(term, document)
  idfreq = idf(term, documents)
  #puts " -> tf:#{tfreq}, idf:#{idfreq}"
  tfreq * idfreq
...
def idf(term, documents)
  ...
  #puts " IDF:#{term}, docL=#{number_of_documents}, wt:#{number_of_documents_with_term}"
...
# For the term 'quantum mechanics', on the other hand, you only want to 
# return document1.
